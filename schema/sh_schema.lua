...
ix.anim.SetModelClass("models/7 hour/combine_soldier_old_b.mdl", "overwatch")
ix.anim.SetModelClass("models/7 hour/ar_combine_soldier_old.mdl", "overwatch")


player_manager.AddValidModel( "overwatch", "models/combine_soldier_notr.mdl", 0, "00000000" )
player_manager.AddValidModel( "overwatch", "models/7 hour/combine_soldier_old_b.mdl", 0, "00000000" )
player_manager.AddValidHands( "overwatch", "models/7 hour/ar_combine_soldier_old.mdl", 0, "00000000" )
