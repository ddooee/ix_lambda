-- "gamemodes\\ixhl2rp\\plugins\\rebeldeployables\\entities\\entities\\ix_normalbarricade.lua"
...
ENT.Type = "anim"
ENT.PrintName = "Makeshift Barricade"
ENT.Category = "HL2 RP"
ENT.Spawnable = true
ENT.AdminOnly = true
...
if (SERVER) then
	function ENT:Initialize()
		self:SetModel("models/props_fortifications/barricade_burning_02.mdl")
