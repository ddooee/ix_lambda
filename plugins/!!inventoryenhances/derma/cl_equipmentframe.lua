...
PLUGIN.slotPlacements = {
	[EQUIP_HEAD] = {x = 6, y = 30, text = "머리"},
	[EQUIP_MASK] = {x = 6, y = 100 + 8, text = "얼굴"},
	[EQUIP_TORSO] = {x = 6, y = 170 + 16, text = "복장"},
	[EQUIP_LEGS] = {x = 285, y = 300, text = "다리"},
	[EQUIP_HANDS] = {x = 285, y = 170 + 16, text = "손"},
	[EQUIP_RADIO] = {x = 6, y = 300, text = "무전기"},
	[EQUIP_CID] = {x = 6, y = 370 + 16, text = "CID"},
	[EQUIP_EARS] = {x = 285, y = 30, text = "귀"}, 
	[EQUIP_RESERVED1] = {x = 285, y = 100 + 8, text = "어깨"},
}
