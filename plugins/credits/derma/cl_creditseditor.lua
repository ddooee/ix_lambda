-- "gamemodes\\ixhl2rp\\plugins\\credits\\derma\\cl_creditseditor.lua"
...
function PANEL:CreateTopBar()
	...
	self.titleText:SetText("이벤트 크레딧 편집기")
...
function PANEL:CreateTitleImageStuff()
    ...
    for i = 1, 3 do
        ...
        textEntry:SetPlaceholderText((i == 1 and "제목 이미지의 너비" or i == 2 and "제목 이미지의 높이" or i == 3 and "제목 이미지의 URL") or "")
...
vgui.Register("Panel", PANEL, "ixEventCreditsEditor")