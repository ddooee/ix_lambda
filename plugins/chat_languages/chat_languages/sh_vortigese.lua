...
CHAT_LANGUAGE.name = "보르티어"
CHAT_LANGUAGE.messageIcon = Material("icon16/bug.png")
CHAT_LANGUAGE.panelIcon = Material("icon16/bug.png", "smooth")
CHAT_LANGUAGE.bNotLearnable = true
CHAT_LANGUAGE.words = {
