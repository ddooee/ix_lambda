...
ix.config.Add("cinematicTextFont", "NanumBarunGothic", "The font used to display cinematic splash texts.", function()
	if (CLIENT) then
...
if CLIENT then
    function PLUGIN:LoadCinematicSplashTextFonts()
        local font = ix.config.Get("cinematicTextFont", "NanumBarunGothic")
