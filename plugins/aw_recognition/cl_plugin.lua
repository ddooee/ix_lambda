...
local VariantsSetsName = {
	["새 이름"] = function(panel)
		Derma_StringRequest("보기의 새 이름 추가","새 이름 입력","Andrey",function(text)
	...
	["본명"] = function() AW_RECOGNIZE_SELECTEDNAME = LocalPlayer():Name() end,
}
...
function PANEL:Init()
	...
	self.PaintOver = function(this,w,h)
        ...
        local text = AW_RECOGNIZE_SELECTEDNAME or "선택되지 않음"
        color = btnColors[2]
...
function PANEL:LoadNames()
	...
	for k,v in pairs(Names) do
		...
		button.DoClick = function(this)
			Derma_Query("다음의 이름으로 인식합니다. :"..k..".","선택","예",
			function() 
