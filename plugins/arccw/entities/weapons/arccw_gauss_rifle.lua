-- "gamemodes\\ixhl2rp\\plugins\\arccw\\entities\\weapons\\arccw_gauss_rifle.lua"
...
SWEP.Category = "Willard - Unusual Weapons" -- edit this if you like
SWEP.AdminOnly = false

SWEP.AutoIconAngle = Angle(90, 0, 0)

SWEP.PrintName = "M2014 가우스 라이플"
