-- "gamemodes\\ixhl2rp\\plugins\\arccw\\entities\\weapons\\arccw_ar21\\shared.lua"
...
SWEP.PrintName = "OSPR2A-EXP"
SWEP.TrueName = "Overwatch Suppression Issue" 
